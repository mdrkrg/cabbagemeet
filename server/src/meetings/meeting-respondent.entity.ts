...
export default class MeetingRespondent {
  ...
  @OneToMany(() => GoogleCalendarCreatedEvent, (googleEvent) => googleEvent.MeetingRespondent)
  GoogleCalendarCreatedEvents: GoogleCalendarCreatedEvent[];

  @OneToMany(() => MicrosoftCalendarCreatedEvent, (msftEvent) => msftEvent.MeetingRespondent)
