...
export function createDataSourceOptions(
  ...
  const commonOptions: Writable<Omit<TypeOrmModuleOptions, "type" | "database" | "poolSize">> = {};
  ...
  if (dbType === "sqlite") {
    ...
    checkEnvVarsExist(["MYSQL_HOST", "MYSQL_USER", "MYSQL_PASSWORD", "MYSQL_DATABASE"], getEnv);
    return {
      type: "mariadb",
...
export default function (configService: ConfigService): TypeOrmModuleOptions {
  ...
  const options = createDataSourceOptions(configService.get.bind(configService), false);
