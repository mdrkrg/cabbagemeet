...
import { addDaysToDateString, daysOfWeekAbbr, getDateFromString } from "utils/dates.utils";
...
export default function Calendar({ firstVisibleDate }: { firstVisibleDate: string }) {
  ...
  const firstDateInGridForPage0 = addDaysToDateString(
    firstVisibleDate,
    -firstSelectedDate_dayOfWeek,
  );
