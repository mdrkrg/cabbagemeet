...
export const oauth2ProviderNames = (
  Object.values(OAuth2ProviderType).filter((val) => typeof val === "string") as string[]
).map(capitalize);
export const oauth2ProviderNamesMap: Record<OAuth2ProviderType, string> = Object.entries(
  OAuth2ProviderType,
)
