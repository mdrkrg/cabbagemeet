...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    loginWithMicrosoft: build.mutation<LoginWithMicrosoftApiResponse, LoginWithMicrosoftApiArg>({
      query: (queryArg) => ({
    ...
    signupWithGoogle: build.mutation<SignupWithGoogleApiResponse, SignupWithGoogleApiArg>({
      query: (queryArg) => ({
    ...
    signupWithMicrosoft: build.mutation<SignupWithMicrosoftApiResponse, SignupWithMicrosoftApiArg>({
      query: (queryArg) => ({
    ...
    getCreatedMeetings: build.query<GetCreatedMeetingsApiResponse, GetCreatedMeetingsApiArg>({
      query: () => ({ url: `/api/me/created-meetings` }),
    }),
    getRespondedMeetings: build.query<GetRespondedMeetingsApiResponse, GetRespondedMeetingsApiArg>({
      query: () => ({ url: `/api/me/responded-meetings` }),
    }),
    linkGoogleCalendar: build.mutation<LinkGoogleCalendarApiResponse, LinkGoogleCalendarApiArg>({
      query: (queryArg) => ({
    ...
    createMeeting: build.mutation<CreateMeetingApiResponse, CreateMeetingApiArg>({
      query: (queryArg) => ({
        url: `/api/meetings`,
        method: "POST",
        body: queryArg,
    ...
    deleteMeeting: build.mutation<DeleteMeetingApiResponse, DeleteMeetingApiArg>({
      query: (queryArg) => ({
        url: `/api/meetings/${queryArg}`,
        method: "DELETE",
      }),
    }),
    scheduleMeeting: build.mutation<ScheduleMeetingApiResponse, ScheduleMeetingApiArg>({
      query: (queryArg) => ({
    ...
    unscheduleMeeting: build.mutation<UnscheduleMeetingApiResponse, UnscheduleMeetingApiArg>({
      query: (queryArg) => ({
        url: `/api/meetings/${queryArg}/schedule`,
        method: "DELETE",
      }),
    }),
    addGuestRespondent: build.mutation<AddGuestRespondentApiResponse, AddGuestRespondentApiArg>({
      query: (queryArg) => ({
    ...
    putSelfRespondent: build.mutation<PutSelfRespondentApiResponse, PutSelfRespondentApiArg>({
      query: (queryArg) => ({
    ...
    deleteRespondent: build.mutation<DeleteRespondentApiResponse, DeleteRespondentApiArg>({
      query: (queryArg) => ({
        url: `/api/meetings/${queryArg.id}/respondents/${queryArg.respondentId}`,
        method: "DELETE",
      }),
...
VerifyEmailAddressResponse | /** status 201  */ UserResponseWithToken;
...
export type LogoutApiArg = /** If true, the user will be logged out everywhere */ boolean;
...
export type LoginWithGoogleApiResponse = /** status 200  */ CustomRedirectResponse;
export type LoginWithGoogleApiArg = OAuth2ConsentPostRedirectDto;
export type LoginWithMicrosoftApiResponse = /** status 200  */ CustomRedirectResponse;
export type LoginWithMicrosoftApiArg = OAuth2ConsentPostRedirectDto;
export type SignupWithGoogleApiResponse = /** status 200  */ CustomRedirectResponse;
...
export type GetCreatedMeetingsApiResponse = /** status 200  */ MeetingsShortResponse;
export type GetCreatedMeetingsApiArg = void;
export type GetRespondedMeetingsApiResponse = /** status 200  */ MeetingsShortResponse;
export type GetRespondedMeetingsApiArg = void;
export type LinkGoogleCalendarApiResponse = /** status 200  */ CustomRedirectResponse;
...
export type LinkMicrosoftCalendarApiResponse = /** status 200  */ CustomRedirectResponse;
export type LinkMicrosoftCalendarApiArg = LinkExternalCalendarDto;
export type UnlinkMicrosoftCalendarApiResponse = /** status 200  */ UserResponse;
export type UnlinkMicrosoftCalendarApiArg = void;
export type GetGoogleCalendarEventsApiResponse = /** status 200  */ OAuth2CalendarEventsResponse;
export type GetGoogleCalendarEventsApiArg = string;
export type GetMicrosoftCalendarEventsApiResponse = /** status 200  */ OAuth2CalendarEventsResponse;
...
export type UpdateAvailabilitiesApiResponse = /** status 200  */ MeetingResponse;
